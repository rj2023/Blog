...
# Add this to ensure Django finds your static files during development
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Ensure this path points to your development static files directory
]
